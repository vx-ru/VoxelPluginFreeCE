...
public:
	...
	// See the Voxel_GetGreedySingleIndex material function
	// See the M_VoxelMaterial_Colors_Greedy material
	UPROPERTY(EditAnywhere, BlueprintReadWrite, AdvancedDisplay, Category = "Voxel - Rendering", meta = (RecreateRender))
	bool bGreedyCubicMesher = false;

	// If true, will only store the single index in the textures
	// Since the alpha is overriden by the texture indexing, the single index will be passed in VertexColor.R
	// See the Voxel_GetGreedySingleIndex material function
	// See the M_VoxelMaterial_MagicaVox_Greedy material
	UPROPERTY(EditAnywhere, BlueprintReadWrite, AdvancedDisplay, Category = "Voxel - Rendering", meta = (EditCondition = "bGreedyCubicMesher", RecreateRender))
	bool bSingleIndexGreedy = false;
